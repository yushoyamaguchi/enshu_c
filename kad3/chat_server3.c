...
int re_name(int n , char *name){

memset(inp, 0, sizeof(inp));
read(csock[n],inp,sizeof(inp));
...
char con_msg6[] ="This name is used. Enter new name.\n";
write(csock[avai_min],con_msg6,sizeof(con_msg6));

while(re_name(avai_min,rbuf)==1){
char con_msg6[] ="This name is used. Enter new name.\n";
write(csock[avai_min],con_msg6,sizeof(con_msg6));
}
